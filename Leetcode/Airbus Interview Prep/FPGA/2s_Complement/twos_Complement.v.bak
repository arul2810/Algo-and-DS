...
module twos_Complement #(
	...
	*/
	...
	parameter NUMBER_OF_BITS = 32; // Default value for the parameters is 32.
...
reg STATE = 2'b00; // By default the state is set to take 1's complement

reg [ NUMBER_OF_BITS : 0 ] ones_complement = 2'b0;
